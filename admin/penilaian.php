            ...
            <div class="card-body">
                <form action="" method="get">
                    <div class="row">
                        <div class="col col-md-3 col-sm-6 pe-0 mb-md-0 mb-2">
                            ...
                            <select id="select-category" class="selectpicker w-100" data-style="btn-default"
                                ...
                                <option value="<?= $d['id_kategori'] ?>"
                                    <?= !empty($id_kategori) && $id_kategori == $d['id_kategori'] ? 'selected' : '' ?>>
                        ...
                        <div class="col col-md-3 col-sm-6 pe-0 mb-md-0 mb-2">
                            <label>Project</label>
                            <select id="select-project" data-id="<?= $id_project ?>" class="selectpicker w-100"
                                data-style="btn-default" name="id_project" data-live-search="true" required></select>
                        </div>
                        <div class="col col-md-3 col-sm-6 pe-0 mb-md-0 mb-2">
                            ...
                            <select class="selectpicker w-100" data-style="btn-default" name="jenis"
                                ...
                                <option value="pk_fpp" <?= !empty($jenis) && $jenis == 'pk_fpp' ? 'selected' : '' ?>>
                                    Penilaian Kinerja Vendor FPP</option>
                                <option value="pk_staff"
                                    <?= !empty($jenis) && $jenis == 'pk_staff' ? 'selected' : '' ?>>Penilaian Kinerja
                                    Vendor Staff</option>
                                <option value="calonvendor"
                                    <?= !empty($jenis) && $jenis == 'calonvendor' ? 'selected' : '' ?>>Penilaian Calon
                                    Vendor Staff</option>
                            </select>
                        </div>
                        ...
                        <tbody>
                            <?php while($d = mysqli_fetch_array($data)) : ?>
                                ...
                                <tr>
                                    ...
                                    <td><?= $d['service']?></td>
                                    <td><?= $d['ratarata']?> </td>
                                    <td><?= $d['status'] == 0 ? 'Belum Dinilai' : 'Sudah Dinilai' ?></td>
                                </tr>
                                <?php elseif ($jenis == 'pk_staff') :?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    ...
                                    <td><?= $d['status_nilai'] == 0 ? 'Belum Dinilai' : 'Sudah Dinilai' ?></td>
                                </tr>
                                <?php elseif ($jenis == 'calonvendor') :?>
                                <tr>
                                    <td><?= $no++ ?></td>
                    ...
                    success: function(data) {
                        ...
                        if (Array.isArray(data)) {
                            $.each(data, function(index, project) {
                                var selected = (project.id_project ==
