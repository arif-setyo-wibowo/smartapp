<?php
session_start();
$title = 'Edit Penilaian Calon Vendor';
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        <tr>
                                            ...
                                            <td>-15</td>
                                            <td><input class="form-check-input m-auto" type="checkbox"
                                                    name="point_10" <?= $calonvendor['point_10'] ? 'checked' : '' ?>
                                                    value="-15" aria-label="Checkbox for following text input">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>-5</td>
                                            <td><input class="form-check-input m-auto" type="checkbox"
                                                    name="point_11" <?= $calonvendor['point_11'] ? 'checked' : '' ?>
                                                    value="-5" aria-label="Checkbox for following text input">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>-10</td>
                                            <td><input class="form-check-input m-auto" type="checkbox"
                                                    name="point_12" <?= $calonvendor['point_12'] ? 'checked' : '' ?>
                                                    value="-10" aria-label="Checkbox for following text input">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>-5</td>
                                            <td><input class="form-check-input m-auto" type="checkbox"
                                                    name="point_13" <?= $calonvendor['point_13'] ? 'checked' : '' ?>
                                                    value="-5" aria-label="Checkbox for following text input">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>-10</td>
                                            <td><input class="form-check-input m-auto" type="checkbox"
                                                    name="point_14" <?= $calonvendor['point_14'] ? 'checked' : '' ?>
                                                    value="-10" aria-label="Checkbox for following text input">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>-15</td>
                                            <td><input class="form-check-input m-auto" type="checkbox"
                                                    name="point_15" <?= $calonvendor['point_15'] ? 'checked' : '' ?>
                                                    value="-15" aria-label="Checkbox for following text input">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>-30</td>
                                            <td><input class="form-check-input m-auto" type="checkbox"
                                                    name="point_16" <?= $calonvendor['point_16'] ? 'checked' : '' ?>
                                                    value="-30" aria-label="Checkbox for following text input">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>-30</td>
                                            <td><input class="form-check-input m-auto" type="checkbox"
                                                    name="point_17" <?= $calonvendor['point_17'] ? 'checked' : '' ?>
                                                    value="-30" aria-label="Checkbox for following text input">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>-30</td>
                                            <td><input class="form-check-input m-auto" type="checkbox"
                                                    name="point_18" <?= $calonvendor['point_18'] ? 'checked' : '' ?>
                                                    value="-30" aria-label="Checkbox for following text input">
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>-60</td>
                                            <td><input class="form-check-input m-auto" type="checkbox"
                                                    name="point_19" <?= $calonvendor['point_19'] ? 'checked' : '' ?>
                                                    value="-60" aria-label="Checkbox for following text input">
                                            </td>
                                            <td>
